...
def print_operation_table(binary_operation, table_rows=6, table_columns=6):
    operation_table = [[binary_operation(i, j) for j in range(1, table_columns + 1)] for i in range(1, table_rows + 1)]
